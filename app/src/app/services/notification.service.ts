...
export class NotificationService extends ApiService {
  ...
  getNotificationsByCourse(courseId: string): Observable<Notification[]> {
    ...
    // Real implementation: return this.get<Notification[]>(`/courses/${courseId}/notifications`);
  }
  ...
  getAllNotifications(): Observable<Notification[]> {
    ...
    return of(fakeNotifications);
    // Real implementation: return this.get<Notification[]>('/notifications');
  }
  ...
  deleteNotification(notificationId: string): Observable<any> {
    ...
    // Real implementation: return this.delete(`/notifications/${notificationId}`);
  }
}
